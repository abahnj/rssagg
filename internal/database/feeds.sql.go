...
SELECT id, name, url, user_id, created_at, updated_at, last_fetched_at FROM feeds WHERE url = $1 LIMIT 1
`
...
SELECT id, name, url, user_id, created_at, updated_at, last_fetched_at FROM feeds ORDER BY created_at DESC
`
